...
Last update : implementation de la messagerie décentralisée avec XMTP. Je suis conscient que ce rajout de code a été fait après la deadline, j'ai quand même préféré terminer le projet avec la figure cadrante plutôt que de ne pas la rendre.
